...
//		update : jdbcTemplate 으로 insert(PreparedStatementCreator 객체 사용)
...
//	게시글 하나를 리턴하기 위해서 BDto 사용(strID : 글 번호)
...
//		dtos = (ArrayList<BDto>) template.query(sql, new BeanPropertyRowMapper(BDto.class));
//		queryForObject : jdbcTemplate 조회 처리
...
////				System.out.println("@# bhit = " + rs.getInt("bhit"));
//				
//				int bid = rs.getInt("bid");
//				String bname = rs.getString("bname");
//				String btitle = rs.getString("btitle");
